...
```{r}
data=read_excel("E:\\disertasi\\DISERTASI JURNAL\\SUBMIT P2\\PENELITIAN JURNAL 1\\DATA UJI TGL 14 AGUSTUS 2023_REV.xlsx")
```
...
library('lavaan')
model=' X1_E_CyberThreatIntelligence=~ECT.01+ECT.02+ECT.03
X2_E_CustomerExperience=~ECX.01+ECX.02+ECX.03
X3_E_ServiceQuality=~ESQ.01+ESQ.02+ESQ.03
X4_E_Trust=~ET.01+ET.02
Y5_E_Satisfaction=~ES.01+ES.02
E_Satisfaction~E_Trust+E_ServiceQuality+E_Trust+_Satisfaction'
